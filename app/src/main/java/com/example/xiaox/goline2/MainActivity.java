...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ellipse strokeEllipse =(Ellipse)findViewById(R.id.strokeEllipse);
        TextCircle textCircle = (TextCircle)findViewById(R.id.textCircle);
        setupEllipses(strokeEllipse,textCircle);
    ...
    private void setupEllipses(Ellipse strokeEllipse, TextCircle textCircle){
        if(strokeEllipse == null || textCircle == null) return;
        strokeEllipse.setFill(Color.TRANSPARENT);
        strokeEllipse.setStrokeFill(skyBlue);
        strokeEllipse.setStroke(4);
        strokeEllipse.setScaleOnTouch(false);
        ...
        strokeEllipse.startAnimation(aniSet);
